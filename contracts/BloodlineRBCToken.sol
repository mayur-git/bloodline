...
/**
 * The Bloodline RBC token (RBC) has a fixed supply and restricts the ability
 ...
 */
contract BloodlineRBCToken is StandardToken, BurnableToken, Ownable {

    // Constants
    string  public constant name = "Bloodline RBC Token";
     ...
     */
    function BloodlineRBCToken(address _admin) {
